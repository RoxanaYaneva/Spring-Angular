            ...
            <TableBody className={classes.bodyText}>
              {this.props.products.map(product => (
                <TableRow key={product.id}>
                  <TableCell style={{fontWeight: "bold", fontSize: 22}} component="th" scope="row">
                    {product.title}
                  </TableCell>
                  <TableCell align="right"></TableCell>
                  <TableCell style={{fontWeight: "bold", fontSize: 22}} align="right">{product.qty}</TableCell>
                  <TableCell style={{fontWeight: "bold", fontSize: 22}} align="right">{product.price}</TableCell>
                  <TableCell style={{fontWeight: "bold", fontSize: 22}} align="right">{product.qty * product.price}</TableCell>
                </TableRow>
              ))}
              <TableRow className={classes.header}>
                ...
                <TableCell></TableCell>
                <TableCell></TableCell>
                <TableCell style={{fontWeight: "bold", fontSize: 20}} align="right">{this.state.total}</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </Grid>
